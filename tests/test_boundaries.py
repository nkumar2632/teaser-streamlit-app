...
def test_ui_never_imports_source_model_or_calculates_model_values():
    for path in [ROOT / "app.py", *(ROOT / "teaser_app" / name for name in
                    ("inputs.py", "presentation.py", "views.py", "cfb_page.py", "market_data.py", "market_compare.py", "market_compare_page.py", "paper_history.py", "strategy.py", "url_ingest.py", "url_import.py", "providers/espn.py"))]:
